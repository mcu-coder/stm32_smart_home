...
{
 /*
    currentDataPoint.valuemode = ;//Add Sensor Data Collection
    ...
    currentDataPoint.valuelightness = ;//Add Sensor Data Collection
    currentDataPoint.valuemq2 = ;//Add Sensor Data Collection
...
void userInit(void)
{
    ...
    /*
      ...
      currentDataPoint.valuestatus = ;
      currentDataPoint.valuetemp = ;
      currentDataPoint.valuehumi = ;
      currentDataPoint.valuetempGate = ;
      currentDataPoint.valuelightness = ;
