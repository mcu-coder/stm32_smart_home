...
* @{
*/
#define PRODUCT_KEY "7c02d57191ad45cd99587cdacc94937f"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "1686ac527d4d43718f78c1979c901b7f"
...
#define humi_MAX                           100
#define humi_LEN                           1
#define tempGate_RATIO                         1
#define tempGate_ADDITION                      -40
#define tempGate_MIN                           0
#define tempGate_MAX                           140
#define tempGate_LEN                           1
#define lightness_RATIO                         1
#define lightness_ADDITION                      0
#define lightness_MIN                           0
#define lightness_MAX                           2000
#define lightness_LEN                           2
#define mq2_RATIO                         0.1
#define mq2_ADDITION                      0
#define mq2_MIN                           0
#define mq2_MAX                           1000
#define mq2_LEN                           2
#define lightnessGate_RATIO                         1
#define lightnessGate_ADDITION                      1
#define lightnessGate_MIN                           0
#define lightnessGate_MAX                           1999
#define lightnessGate_LEN                           2
...
typedef struct {
  ...
  bool valuelight;
  uint32_t valuemode;
  uint32_t valuestatus;
  int32_t valuetemp;
  uint32_t valuehumi;
  int32_t valuetempGate;
  uint32_t valuelightness;
  float valuemq2;
  uint32_t valuelightnessGate;
} dataPoint_t;

/** User Area Device State Structure */
typedef struct {
  uint8_t flagaircondi:1;
  uint8_t flagcurtain:1;
  uint8_t flaglight:1;
  uint8_t flagmode:1;
  uint8_t flagstatus:1;
  uint8_t flagtemp:1;
  uint8_t flaghumi:1;
  uint8_t flagtempGate:1;
  uint8_t flaglightness:1;
  uint8_t flagmq2:1;
  uint8_t flaglightnessGate:1;
} dataPointFlags_t;
...
typedef struct {
  ...
  uint8_t valuetemp;
  uint8_t valuehumi;
  uint8_t valuetempGate;
  uint16_t valuelightness;
  uint16_t valuemq2;
  uint16_t valuelightnessGate;
} devStatus_t;
